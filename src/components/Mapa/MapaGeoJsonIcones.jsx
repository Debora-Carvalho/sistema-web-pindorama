...
import brasilEstados from "./data/brazil_geo.json"; // seu GeoJSON com propriedades de estilo
import patrimonioData from "./data/mapa.json"; // pontos culturais
...
export default function MapaBrasilEstilizado() {
  return (
    <MapContainer
